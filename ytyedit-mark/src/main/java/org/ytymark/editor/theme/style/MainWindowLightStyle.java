 ...
 * 描述：主窗口的白天模式
 */
public class MainWindowLightStyle extends AbstractStyle {
    private static final String STYLE_PATH = "/css/ui/main-light.css";
    private String backgroundColor = "rgba(255, 255, 255, 0.8)";
    ...
    public String getCss() {
        return  getFonts() +
                ...
                "code { font-family: 'Courier New', monospace; background: #f4f4f4; padding: 2px 0px; border-radius: 4px; }" +
                "ul { margin: 20px 0; padding-left: 20px; }" +
                "ul li { margin: 5px 0; }" +
                "strong { font-family: 'SourceHanSansSC-Bold', sans-serif;   }"+
                "table {border: 1px solid #ccc; border-collapse: collapse;}"+
                "table th,table td {border: 1px solid #ddd; padding: 8px; text-align: left;}"+
                "table th { font-family: 'SourceHanSansSC-Bold', 'Arial', sans-serif; }"+
